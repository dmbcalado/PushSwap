...
<p> Where we can see the stack a with the 5 middle numbers and the b has the stacks ordered and the outliers randomly distributed inside the stacks (the orange lines). </p>
